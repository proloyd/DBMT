function [ c_mt_est ] = MTSpectogram( y,W,overlap,time_halfbandwidth,num_seq,Fs )
%MTSpectogram( y,N,overlap,time_halfbandwidth,num_seq,Fs ) computes multitaper
% Spectrogram of y, with the following specifications:
