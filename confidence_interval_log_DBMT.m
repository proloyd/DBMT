...
%confidence_interval_log_DBMT(n, num_seq) plots 95% confidence interval for
%log_DBMT estimate at nth window assuming num_seq number of tapers were 
%used in that estimate. The multiplier can be changed to obtain any other 
%confidence level.
